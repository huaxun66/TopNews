 ...
 * Original file: C:\\Users\\huanxuan\\Desktop\\Project\\PRO\\TopNews_3.4\\TopNews_3.4\\TopNews\\src\\com\\huaxun\\radio\\provider\\IMediaPlaybackService.aidl
 */
package com.huaxun.radio.provider;
public interface IMediaPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.huaxun.radio.provider.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.huaxun.radio.provider.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an com.huaxun.radio.provider.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static com.huaxun.radio.provider.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.huaxun.radio.provider.IMediaPlaybackService))) {
return ((com.huaxun.radio.provider.IMediaPlaybackService)iin);
}
return new com.huaxun.radio.provider.IMediaPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.huaxun.radio.provider.IMediaPlaybackService
{
