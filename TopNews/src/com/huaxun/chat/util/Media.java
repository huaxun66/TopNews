...
public class Media {
	...
	// 音频文件保存地址
	public String sendpath, receivepath;
	...
	{		
		if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
			try {				
				sendpath = FileUtil.getCacheAudioPath() + "/MessageMediaSend";
		...
		if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
			try {
				receivepath = FileUtil.getCacheAudioPath() + "/MessageMediaReceive";
	...
	public void startRecord()
	{
		...
		//保存路径
		this.name="CHAT"+Tools.getRandomId() + new SimpleDateFormat("yyyyMMddHHmmss")
		          .format(System.currentTimeMillis())+ ".amr";
