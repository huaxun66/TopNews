...
public class User implements Serializable {
	...
	public User(String name, int headIconPos, String ip, int unReadMsgCount, long time) {
		super();
		this.name = name;
		this.headIconPos=headIconPos;
		this.ip = ip;
	...
	public User getCopy()
	{
		User u=new User(this.name,this.headIconPos,this.ip,this.unReadMsgCount,this.OnlineTime);	
		return u;
	}
