...
public class ImageCycleView extends LinearLayout {
	 ...
	 * 装填图片数据
	 */
	public void setImageResources(ArrayList<RadioItem> newsList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		...
		mAdvAdapter = new ImageCycleAdapter(mContext, newsList, imageCycleViewListener);
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		public ArrayList<RadioItem> mAdList = new ArrayList<RadioItem>();
		...
		public ImageCycleAdapter(Context context, ArrayList<RadioItem> adList, ImageCycleViewListener imageCycleViewListener) {
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			RadioItem news = mAdList.get(position % mAdList.size());
			String imageURL = Util.getTestImageURL(news.imgurl1);
			...
			iv_play.setVisibility(null != news && news.newstype.equals("7") ? View.VISIBLE : View.GONE);
			TextView textview = (TextView) view.findViewById(R.id.tv_cycle_title);
			textview.setText(news.newstitle);
//			textview.setTextColor(AppSettings.NIGHT_MODE ? getResources().getColor(R.color.night_news_read_none)
