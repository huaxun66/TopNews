 ...
 */
public class HotNewsDetailActivity extends Activity implements OnClickListener{
	...
	private String PATH = NewsUrls.HOT_NEWS_DETAIL;	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		item = (HotNews) intent.getSerializableExtra("HotNews");
	...
	private void initView() {
		...
		if (favoriteDB.isHotNewsFavorite(item)) {
			favorite_news.setImageResource(R.drawable.ic_action_favor_on_normal);
		}
		if (item!=null) {
			loadHotNewsDetailInfo();
		}
		
 	}
	
	public void loadHotNewsDetailInfo() {
		String url = PATH + item.getHotId();
